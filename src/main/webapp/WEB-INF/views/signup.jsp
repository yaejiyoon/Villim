...
<body>
	...
	<div id="wrapper">
		...
		<div id="middle">
				...
				<input type="text" name="secondName" class="form-control"
					...
					value="${secondName}" id="secondNm"><i class="far fa-user fa-2x" id="secondIcon"></i>
		
			
				<input type="text" name="firstName" class="form-control"
					placeholder="성을 입력하세요" aria-describedby="basic-addon2"
					value="${firstName}" id="firstNm"><i class="far fa-user fa-2x" id="firstIcon"></i>
		
			
				<input type="text" name="accountEmail" class="form-control"
					placeholder="이메일을 입력하세요" aria-describedby="basic-addon2"
					value="${accountEmail}" id="accountEm"><i class="fas fa-envelope fa-2x" id="emailIcon"></i>
	...
	<div class="modal fade" id="myModal3" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="mheader3">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="mheader4">
