											...
											<!-- if 구매를 하고 체크인 날짜이후부터 리뷰쓰기 가능 -->
												...
												<div class="form-group">
													<div class="col-sm-10 col-sm-offset-2">
														<div id="hostInfo">
															<h5
																style="color: #595c63; position: relative; left: 140px; font-weight: bold;">리뷰는
																체크아웃 후에 쓸 수 있습니다.</h5>
															<img
																src="https://secure.gravatar.com/avatar/de9b11d0f9c0569ba917393ed5e5b3ab?s=140&r=g&d=mm"
																class="img-circle" id="hostPhoto">
															<h4
																style="position: relative; left: 27px; color: #595c63; font-weight: bold;">James
																Bro</h4>
														</div>
														<h5 style="position: relative; top: -155px;">샌디에이고에서
															5성급 펜션 을 위한 공개 리뷰 작성기간 11일 기간을 드립니다.</h5>
														<a href="reviewWrite.mo"
															style="position: relative; top: -140px; color: #ff5959; text-decoration: none;">리뷰쓰기</a>
