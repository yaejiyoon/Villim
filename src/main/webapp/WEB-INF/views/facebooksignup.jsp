...
<script>
	$(document)
			.ready(
					...
					var fbSeconNm = $('#fbNameBtn',opener.document).val().split("  ")[0];
					var fbFirstNm = $('#fbNameBtn',opener.document).val().split("  ")[1];
					
					$("#accountEm").val($('#fbEmailBtn',opener.document).val());
					$("#secondNm").val(fbSeconNm);
					$("#firstNm").val(fbFirstNm);
					$("#profilePicture").attr("src",$('#fbImgBtn',opener.document).val());
					var pw = $('#fbIdBtn',opener.document).val();
						...
						$("#imgLoadBtn").click(function(){
							if(load==""){
								...
								load = $('#fbImgBtn',opener.document).val();
...
<body>
		...
		<div id="bottom">
			...
			<div class="dropdown" id="year" style="display: inline;">
				<input type="text" name="yearProp" placeholder="년" id="yearInput" class="form-control"><a
					...
					id="yearBtn" style="cursor: pointer;"> <!-- 				<button type="button" data-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false" id="yearBtn">
					년 <span class="caret"></span>
				</button> --> <span class="caret" id="droplist3"></span></a>
				<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel"
			...
			<div class="modal-content">
				...
				<div class="modal-footer" id="mfooter">
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						data-toggle="modal" data-target="#myModal1" id="iamagree">동의</button>
	...
	<div class="modal fade" id="myModal2" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" id="mheader2">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div>
						...
						<input type="hidden" id="memberType" name="member_type">
