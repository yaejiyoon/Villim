		...
		<div id="footer-contents">
			...
			<div id="contents03" class="contents">
				...
				<ul>
					...
					<li><a href="">호스트 추천하기</a> <img src="<c:url value='/resources/img/new.png'/>" style="widht:10px; margin-left: 5px;"></li>
			...
			<div id="contents04" class="contents">
				<img src="<c:url value='/resources/img/facebook.png'/>" style="margin-left:5px;">
				<img src="<c:url value='/resources/img/twitter.png'/>" style="margin-left:5px;">
				<img src="<c:url value='/resources/img/instagram.png'/>" style="margin-left:8px;">
